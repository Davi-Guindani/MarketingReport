...
class Info(ABC):
    __instagram_business_account_id = "17841401892691217"
    __api_version = "v15.0"
    __teste = ["email_contacts", "follower_count", "get_directions_clicks", "impressions", "phone_call_clicks", "profile_views", "reach", "text_message_clicks", "website_clicks"]
